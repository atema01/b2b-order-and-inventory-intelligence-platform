...
\restrict jFbXO2TPBa4E8LSVcZQv2EyjCzFGM9Doj3NZJWprwYFNNZoAeIuTEneqr6TBFF2
...
CREATE TABLE public.roles (
    ...
    name character varying(100) NOT NULL,
    description text DEFAULT ''::text,
    access_level character varying(50) DEFAULT 'Staff'::character varying NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now()
);
...
CREATE TABLE public.users (
    ...
    CONSTRAINT users_role_check CHECK (((role)::text = ANY ((ARRAY['admin'::character varying, 'staff'::character varying, 'buyer'::character varying])::text[]))),
...
--
-- Name: idx_credit_requests_one_per_order; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_credit_requests_one_per_order ON public.credit_requests USING btree (order_id) WHERE (order_id IS NOT NULL);
...
\unrestrict jFbXO2TPBa4E8LSVcZQv2EyjCzFGM9Doj3NZJWprwYFNNZoAeIuTEneqr6TBFF2
