...
CREATE INDEX IF NOT EXISTS idx_credit_repayments_credit_request ON public.credit_repayments USING btree (credit_request_id, repaid_at DESC, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_credit_requests_buyer ON public.credit_requests USING btree (buyer_id);
...
CREATE INDEX IF NOT EXISTS idx_demand_forecasts_generated_at ON public.demand_forecasts USING btree (generated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_demand_forecasts_product_model ON public.demand_forecasts USING btree (product_id, model);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_demand_forecasts_scope ON public.demand_forecasts USING btree (model, forecast_scope, scope_key);
...
CREATE INDEX IF NOT EXISTS idx_payments_buyer ON public.payments USING btree (buyer_id);
...
CREATE INDEX IF NOT EXISTS idx_payments_credit_request ON public.payments USING btree (credit_request_id, date_time DESC);
...
CREATE INDEX IF NOT EXISTS idx_pricing_rules_name ON public.pricing_rules USING btree (name);
...
CREATE INDEX IF NOT EXISTS idx_return_logs_buyer_id ON public.return_logs USING btree (buyer_id);
...
CREATE INDEX IF NOT EXISTS idx_return_logs_date ON public.return_logs USING btree (date);
...
CREATE INDEX IF NOT EXISTS idx_return_logs_order_id ON public.return_logs USING btree (order_id);
...
CREATE INDEX IF NOT EXISTS idx_return_logs_product_id ON public.return_logs USING btree (product_id);
