...
const MarginRuleDetails: React.FC = () => {
  ...
  useEffect(() => {
    if (id) {
      const r = db.getMarginRule(id);
      if (r) {
        setRule(r);
        setForm({ 
          minUnitCost: r.minUnitCost, 
          minMarginPercentage: r.minMarginPercentage, 
          bonusDiscount: r.bonusDiscount 
        });
      }
    }
  }, [id]);
