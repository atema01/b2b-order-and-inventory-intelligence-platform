  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center p-4">
      <div className="w-full max-w-[400px] flex flex-col items-center">
        ...
        {/* Logo/Icon */}
        <div className="bg-[#005A9C] rounded-[20px] size-[72px] flex items-center justify-center shadow-lg shadow-[#005A9C]/30 mb-8">
        ...
        <p className="text-[#64748B] text-center text-[15px] leading-relaxed mb-10 font-medium max-w-[320px]">
          {t('login.sellerSubtitle')}
        </p>

        {/* Form */}
        <form onSubmit={handleSubmit} className="w-full space-y-5">
          <div className="space-y-2">
            <label className="text-[13px] font-semibold text-[#0F172A] block">{t('login.staffIdLabel')}</label>
          ...
          <div className="flex justify-end pt-1">
            <button type="button" className="text-[13px] font-bold text-[#005A9C] hover:opacity-80 transition-opacity">
              {t('login.forgot')}
            </button>
          </div>
          ...
          <button 
            type="submit"
            disabled={isLoading}
            className="w-full h-[56px] bg-[#005A9C] hover:bg-[#004a80] active:scale-[0.98] transition-all rounded-[12px] text-white font-bold text-[16px] shadow-lg shadow-[#005A9C]/20 flex items-center justify-center gap-2 mt-4 disabled:opacity-70"
          >
        ...
        {/* Footer Box */}
        <div className="w-full mt-12 bg-[#F0F7FF] border border-[#E0F2FE] rounded-[20px] p-6 text-center">
          <p className="text-[14px] font-medium text-[#0F172A] mb-3">{t('login.needAccess')}</p>
          <div className="flex items-center justify-center gap-4 text-[14px] font-bold text-[#005A9C]">
        ...
        <p className="mt-8 text-[#CBD5E1] text-[11px] font-medium">{t('auth.secure')}</p>
      </div>
    </div>
  );
};
