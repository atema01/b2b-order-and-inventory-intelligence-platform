...
const BuyerPayment: React.FC = () => {
  ...
  useEffect(() => {
    if (orderId) {
      ...
      if (o) {
        setOrder(o);
        setPayAmount(o.total - (o.amountPaid || 0)); // Default to remaining amount
      }
    }
  }, [orderId]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const newPayment: Payment = {
        ...
        amount: payAmount,
        method: form.method,
        referenceId: form.reference || 'IMG-REF',
        dateTime: new Date().toLocaleString(),
        proofImage: form.image || 'https://via.placeholder.com/400x600?text=No+Image+Provided',
